<div class="row">
    <div class="admin-header">
        <span><a href="/admin">Админ панель</a> / <a href="/admin/cheats">Коды и прохождения игр</a> / Редактирование</span>
...
<div class="row">
    <div class="admin-content">
        <form action="" class="form_add" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="title" id="title_news" class="title_news" value="<?=(isset($editCheat['title'])) ? $editCheat['title'] : '' ?>">

            <label for="cat_news">Выберите категорию</label>
            <select name="category" id="category">
                <? foreach ($categories as $category): ?>
                    <? if ($category['id'] == $editCheat['cat_news']): ?>
            ...
            <div class="block_desc">
                ...
                <textarea name="desc" id="desc_news" ><?=$editCheat['description']?></textarea>
                <script>
            ...
            <img style="width: 100px;" src="/public/images/upload_file/<?=$editCheat['image']?>" alt="">
            <input type="file" class="image_title" name="add_image" src="" alt="">

            <label for="meta_desc">Мета-тег Description:</label>
            <textarea name="meta_desc" id="meta_desc"><?=$editCheat['meta_desc']?></textarea>

            <label for="meta_keywords">Мета-тег Keywords:</label>
            <textarea name="meta_keywords" id="meta_keywords"><?=$editCheat['meta_keywords']?></textarea>
