...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 25 2021 г., 20:39
...
INSERT INTO `articles` (`id`, `cat_article`, `title`, `description`, `author`, `date`, `image`, `meta_desc`, `meta_keywords`, `showSlider`) VALUES
...
(2, 'user', '$2y$10$gtarD9lfSiKmRBIoPpVffe/UGoQAOig4tsWgxvXNzYgoJhGCsM7uK', 'Модератор', 'user@mail.ru', 'hitman.jpg', 'modeator'),
(3, 'allex', '$2y$10$aL2wI7fntz8cqRQqSQvcGuMLqZdgZ8m0HNrfoHUiXiWf03olmMm/u', 'Алексей', 'all@mail.ru', '1', 'user');
...
(1, '127.0.0.1', 'news', 5, 64),
(2, '127.0.0.1', 'news', 4, 14),
(3, '127.0.0.1', 'articles', 4, 29),
(4, '127.0.0.1', 'news', 2, 7),
(5, '127.0.0.1', 'cheats', 2, 17),
(6, '127.0.0.1', 'cheats', 1, 10),
(7, '127.0.0.1', 'news', 1, 28),
(8, '127.0.0.1', 'cheats', 4, 25),
(9, '127.0.0.1', 'news', 3, 12),
(10, '127.0.0.1', 'articles', 1, 7),
(11, '127.0.0.1', 'articles', 3, 3),
(12, '127.0.0.1', 'cheats', 3, 3),
